...
const Classes = ({ text }) => {
  ...
  return (
    <section css={styles} className="ourClasses" id="ourClasses">
      ...
      <Icon />
      <p>
      Look no further for a wide variety of Folsom fitness classes to fit into your schedule. 
        <br />
        Our Folsom yoga schedule alone includes all levels of yoga, plus Pilates and Piloga.
      </p>
      <Container>
